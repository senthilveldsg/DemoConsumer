 ...
 */
package com.dcsg.pc.eventing.schema.style;
...
public class StyleAttribute extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<StyleAttribute> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<StyleAttribute> DECODER =
   ...
   */
  public static BinaryMessageEncoder<StyleAttribute> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<StyleAttribute> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<StyleAttribute> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this StyleAttribute to a ByteBuffer.
  ...
  /**
   * Deserializes a StyleAttribute from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a StyleAttribute instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static StyleAttribute fromByteBuffer(
   ...
   */
  public StyleAttribute(java.lang.CharSequence eventId, java.lang.CharSequence styleCode, com.dcsg.pc.eventing.schema.common.Attribute attribute, com.dcsg.pc.eventing.schema.common.AttributeAction attributionAction, java.lang.CharSequence createdBy, java.time.Instant createdOn) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: styleCode = (java.lang.CharSequence)value$; break;
  ...
  /**
   * Creates a new StyleAttribute RecordBuilder.
   * @return A new StyleAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder newBuilder() {
    return new com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder();
  }

  /**
   * Creates a new StyleAttribute RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new StyleAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder newBuilder(com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder(other);
    }
  }

  /**
   * Creates a new StyleAttribute RecordBuilder by copying an existing StyleAttribute instance.
   * @param other The existing instance to copy.
   * @return A new StyleAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder newBuilder(com.dcsg.pc.eventing.schema.style.StyleAttribute other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder(other);
  ...
  /**
   * RecordBuilder for StyleAttribute instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StyleAttribute>
    implements org.apache.avro.data.RecordBuilder<StyleAttribute> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (isValidValue(fields()[1], other.styleCode)) {
        this.styleCode = data().deepCopy(fields()[1].schema(), other.styleCode);
    ...
    /**
     * Creates a Builder by copying an existing StyleAttribute instance
     * @param other The existing instance to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.style.StyleAttribute other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setEventId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setStyleCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearStyleCode() {
      styleCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setAttribute(com.dcsg.pc.eventing.schema.common.Attribute value) {
    ...
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setAttributeBuilder(com.dcsg.pc.eventing.schema.common.Attribute.Builder value) {
      clearAttribute();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearAttribute() {
      attribute = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setAttributionAction(com.dcsg.pc.eventing.schema.common.AttributeAction value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearAttributionAction() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setCreatedBy(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearCreatedBy() {
      createdBy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder setCreatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.style.StyleAttribute.Builder clearCreatedOn() {
    ...
    public StyleAttribute build() {
      try {
        StyleAttribute record = new StyleAttribute();
        record.eventId = fieldSetFlags()[0] ? this.eventId : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.styleCode = fieldSetFlags()[1] ? this.styleCode : (java.lang.CharSequence) defaultValue(fields()[1]);
        if (attributeBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<StyleAttribute>
    WRITER$ = (org.apache.avro.io.DatumWriter<StyleAttribute>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<StyleAttribute>
    READER$ = (org.apache.avro.io.DatumReader<StyleAttribute>)MODEL$.createDatumReader(SCHEMA$);
