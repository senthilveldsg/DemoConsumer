...
public class AttributeValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4012076879451668749L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AttributeValue\",\"namespace\":\"com.dcsg.pc.eventing.schema.syndigopimcopy\",\"fields\":[{\"name\":\"value\",\"type\":\"string\"}]}");
   ...
   */
  public static BinaryMessageEncoder<AttributeValue> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a AttributeValue instance decoded from the given buffer
   ...
   */
  public AttributeValue(java.lang.CharSequence value) {
    this.value = value;
  }
   ...
   */
  public static com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder newBuilder() {
    return new com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder();
  }
   ...
   * @return A new AttributeValue RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder newBuilder(com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder(other);
    }
  }
   ...
   * @return A new AttributeValue RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder newBuilder(com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttributeValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.syndigopimcopy.AttributeValue.Builder clearValue() {
      value = null;
