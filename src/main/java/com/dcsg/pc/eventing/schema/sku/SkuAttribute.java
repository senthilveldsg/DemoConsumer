 ...
 */
package com.dcsg.pc.eventing.schema.sku;
...
public class SkuAttribute extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<SkuAttribute> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SkuAttribute> DECODER =
   ...
   */
  public static BinaryMessageEncoder<SkuAttribute> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SkuAttribute> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SkuAttribute> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SkuAttribute to a ByteBuffer.
  ...
  /**
   * Deserializes a SkuAttribute from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SkuAttribute instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SkuAttribute fromByteBuffer(
   ...
   */
  public SkuAttribute(java.lang.CharSequence eventId, java.lang.CharSequence skuNumber, com.dcsg.pc.eventing.schema.common.Attribute attribute, com.dcsg.pc.eventing.schema.common.AttributeAction attributionAction, java.lang.CharSequence createdBy, java.time.Instant createdOn) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: skuNumber = (java.lang.CharSequence)value$; break;
  ...
  /**
   * Creates a new SkuAttribute RecordBuilder.
   * @return A new SkuAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder newBuilder() {
    return new com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder();
  }

  /**
   * Creates a new SkuAttribute RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SkuAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder newBuilder(com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder(other);
    }
  }

  /**
   * Creates a new SkuAttribute RecordBuilder by copying an existing SkuAttribute instance.
   * @param other The existing instance to copy.
   * @return A new SkuAttribute RecordBuilder
   */
  public static com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder newBuilder(com.dcsg.pc.eventing.schema.sku.SkuAttribute other) {
    if (other == null) {
      return new com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder();
    } else {
      return new com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder(other);
  ...
  /**
   * RecordBuilder for SkuAttribute instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SkuAttribute>
    implements org.apache.avro.data.RecordBuilder<SkuAttribute> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (isValidValue(fields()[1], other.skuNumber)) {
        this.skuNumber = data().deepCopy(fields()[1].schema(), other.skuNumber);
    ...
    /**
     * Creates a Builder by copying an existing SkuAttribute instance
     * @param other The existing instance to copy.
     */
    private Builder(com.dcsg.pc.eventing.schema.sku.SkuAttribute other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setEventId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setSkuNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearSkuNumber() {
      skuNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setAttribute(com.dcsg.pc.eventing.schema.common.Attribute value) {
    ...
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setAttributeBuilder(com.dcsg.pc.eventing.schema.common.Attribute.Builder value) {
      clearAttribute();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearAttribute() {
      attribute = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setAttributionAction(com.dcsg.pc.eventing.schema.common.AttributeAction value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearAttributionAction() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setCreatedBy(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearCreatedBy() {
      createdBy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder setCreatedOn(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dcsg.pc.eventing.schema.sku.SkuAttribute.Builder clearCreatedOn() {
    ...
    public SkuAttribute build() {
      try {
        SkuAttribute record = new SkuAttribute();
        record.eventId = fieldSetFlags()[0] ? this.eventId : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.skuNumber = fieldSetFlags()[1] ? this.skuNumber : (java.lang.CharSequence) defaultValue(fields()[1]);
        if (attributeBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SkuAttribute>
    WRITER$ = (org.apache.avro.io.DatumWriter<SkuAttribute>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SkuAttribute>
    READER$ = (org.apache.avro.io.DatumReader<SkuAttribute>)MODEL$.createDatumReader(SCHEMA$);
